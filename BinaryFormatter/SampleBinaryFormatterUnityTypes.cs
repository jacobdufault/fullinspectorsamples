...
namespace FullInspector.Samples.BinaryFormatterSample {
    [AddComponentMenu("Full Inspector Samples/Binary Formatter/Unity Types")]
    public class SampleBinaryFormatterUnityTypes : BaseBehavior<BinaryFormatterSerializer> {
        [Serializable]
