...
namespace FullInspector.Samples.Other.Delegates {
    ...
    public class DelegateSampleBehavior : BaseBehavior<JsonNetSerializer> {
        [InspectorMargin(10)]
        ...
        public void MyIntBaseBehaviorConsumer(int a, BaseBehavior<JsonNetSerializer> b) {
            Debug.Log(string.Format("MyIntBaseBehaviorConsumer({0}, {1}) called", a, b));
        }

        public BaseBehavior<JsonNetSerializer> MyBaseBehaviorGenerator() {
            return this;
        }
